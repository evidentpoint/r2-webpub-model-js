export default {
  ...
  metadata: {
    ...
    title: 'Moby-Dick',
    subtitle: { en: 'or, The Whale', fr: 'ou, le Cachalot' },
    modified: '2015-09-29T17:00:00.000Z',
    published: '1851-10-18T00:00:00.000Z',
    language: ['en', 'fr'],
    sortAs: 'Moby-Dick',
    author: {
      name: { en: 'Herman Melville', fr: 'Herman Melville' },
      identifier: 'https://orcid.org/0000-0002-1825-0097',
      sortAs: 'Melville, H.',
    },
    editor: { name: 'Richard Bentley' },
    illustrator: { name: 'Rockwell Kent' },
  ...
  resources: [
    ...
    { rel: 'contents', href: 'https://example.com/contents.html', type: 'text/html' },
    { rel: ['foo', 'bar'], href: 'https://example.com/foobar.txt', type: 'text/plain' },
